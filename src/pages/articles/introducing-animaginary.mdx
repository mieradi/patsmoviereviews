...
export const meta = {
  ...
  title: 'I am art',
  description:
    'Armed with an encyclopedic repertoire of movie facts and trivia, I proudly adorn the mantle of a film savant, perpetually ready to engage in impassioned discussions and debates, believing that my discerning eye discerns the subtlest details others may overlook',
}
