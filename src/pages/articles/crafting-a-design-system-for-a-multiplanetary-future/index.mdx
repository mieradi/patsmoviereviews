...
export const meta = {
  author: 'Adam Wathan',
  date: '2022-09-05',
  title: 'My incredible brain',
  description:
    'In the vast universe of celluloid dreams, I stand unyielding as a self-proclaimed guardian of cinematic knowledge, brimming with a fervent conviction that I possess an unrivaled expertise in the realm of movies',
}
